...
const InformeVonsucro = () => {

    // Query
    const {data, loading, error} = useQuery(INFORME_VONSUCRO)
    // State
        ...
        <div className="container-fluid grey lighten-4 p-0">
            <div className="row">
                <div className="col s12 p-1">
                    ...
                    <div className={verData ? 'col s9 p-2' : 'col s12 p-2'}>
                        <div className="col s12 p-2">
                            <div className='col s10'>
                                <h1 className="center title" style={{paddingLeft: '20%'}}> Seleccione la información </h1>
                            </div>
                            <div className='col s2 p-2 center'>
                                <button type='button' className='btnVerDatos' onClick={() => setVerData(true)}>Ver Datos</button>
                            </div>
                        </div>

                        <div className="col s12 p-2">
                            {obtenerInformeVonsucro.length === 0 ?
                                'No hay suertes registradas'
                            :
